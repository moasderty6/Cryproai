...
📈 <b>تحليل المؤشرات</b>
RSI: اكتب سطر ونصف النسبة وتوضيح بالعربي فقططط ولا حرف غير لعربي
MACD: اكتب سطر ونصف توضيح بالعربي فقططط ولا حرف غير لعربي
Bollinger Bands: اكتب سطر ونص توضيح بالعربي فقططط ولا حرف غير لعربي
Volume: اكتب سطر ونص توضيح بالعربي فقططط ولا حرف غير لعربي
"""
        )
    else:
        prompt = (
